...
if {[string length [info commands new_project]]} {
   new_project -name Increment_Behavior -folder "D:/CAD/cad_lib/ps/Increment_Behavior"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Increment_Behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/Increment_Behavior/hds/add_files.tcl"}
