...
if {[string length [info commands new_project]]} {
   new_project -name pipeline_Structure -folder "G:/CAD/cad_lib/ps/pipeline_Structure"
} else {
   set_working_dir "G:/CAD/cad_lib/ps/pipeline_Structure"
}
...
catch {source "G:/CAD/cad_lib/ps/pipeline_Structure/hds/add_files.tcl"}
