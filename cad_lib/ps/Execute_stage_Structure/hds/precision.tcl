...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/Execute_stage_Structure/Execute_stage_Structure.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Execute_stage_Structure"
}
...
catch {source "D:/CAD/cad_lib/ps/Execute_stage_Structure/hds/add_files.tcl"}
