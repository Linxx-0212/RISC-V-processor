...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/Fetch_new_Structure/Fetch_new_Structure.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Fetch_new_Structure"
}
...
catch {source "D:/CAD/cad_lib/ps/Fetch_new_Structure/hds/add_files.tcl"}
