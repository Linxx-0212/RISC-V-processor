...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/Fetch_Behavior/Fetch_Behavior.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Fetch_Behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/Fetch_Behavior/hds/add_files.tcl"}
