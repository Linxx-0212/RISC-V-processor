...
if {[string length [info commands new_project]]} {
   new_project -name Arbiter_Behavior -folder "D:/CAD/cad_lib/ps/Arbiter_Behavior"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Arbiter_Behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/Arbiter_Behavior/hds/add_files.tcl"}
