...
if {[string length [info commands new_project]]} {
   new_project -name Mux2_Behavior -folder "D:/CAD/cad_lib/ps/Mux2_Behavior"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Mux2_Behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/Mux2_Behavior/hds/add_files.tcl"}
