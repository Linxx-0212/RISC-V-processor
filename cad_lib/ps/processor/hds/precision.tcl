...
if {[string length [info commands new_project]]} {
   open_project "G:/CAD/cad_lib/ps/processor/processor.psp"
   new_impl
} else {
   set_working_dir "G:/CAD/cad_lib/ps/processor"
}
...
catch {source "G:/CAD/cad_lib/ps/processor/hds/add_files.tcl"}
