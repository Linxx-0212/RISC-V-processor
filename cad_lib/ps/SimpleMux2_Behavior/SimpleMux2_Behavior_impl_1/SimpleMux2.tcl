if { ![project_exists {SimpleMux2}] } {
     project_new {SimpleMux2}
} else {
     project_open {SimpleMux2}
}
set_project_settings -cmp {SimpleMux2}
if { ![project_settings_exist -sim SimpleMux2] } {
        set_project_settings -sim SimpleMux2
}
set_global_assignment -section_id {SimpleMux2} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {EDIF_FILE} {SimpleMux2.edf}
...
if { [file exists {SimpleMux2_altera.prop}] } {
  source SimpleMux2_altera.prop
}
set_global_assignment -name {FAMILY} {MAXV}
set_global_assignment -section_id {SimpleMux2} -name {DEVICE} {5M2210ZF324A5}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {SimpleMux2_pnr_constraints.sdc}
