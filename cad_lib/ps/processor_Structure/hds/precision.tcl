...
if {[string length [info commands new_project]]} {
   open_project "G:/CAD/cad_lib/ps/processor_Structure/processor_Structure.psp"
   new_impl
} else {
   set_working_dir "G:/CAD/cad_lib/ps/processor_Structure"
}
...
catch {source "G:/CAD/cad_lib/ps/processor_Structure/hds/add_files.tcl"}
