...
if {[string length [info commands new_project]]} {
   new_project -name Test_bench_decoder_Testbench -folder "D:/CAD/cad_lib/ps/Test_bench_decoder_Testbench"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Test_bench_decoder_Testbench"
}
...
catch {source "D:/CAD/cad_lib/ps/Test_bench_decoder_Testbench/hds/add_files.tcl"}
