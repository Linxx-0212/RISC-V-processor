...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/Reg_tracker_Behavior/Reg_tracker_Behavior.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Reg_tracker_Behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/Reg_tracker_Behavior/hds/add_files.tcl"}
