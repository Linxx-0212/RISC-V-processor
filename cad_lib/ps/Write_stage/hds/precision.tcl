...
if {[string length [info commands new_project]]} {
   new_project -name Write_stage -folder "D:/CAD/cad_lib/ps/Write_stage"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Write_stage"
}
...
catch {source "D:/CAD/cad_lib/ps/Write_stage/hds/add_files.tcl"}
