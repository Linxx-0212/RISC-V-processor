...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/Decoder_Behavior/Decoder_Behavior.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Decoder_Behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/Decoder_Behavior/hds/add_files.tcl"}
