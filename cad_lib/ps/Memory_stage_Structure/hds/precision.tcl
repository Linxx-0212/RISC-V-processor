...
if {[string length [info commands new_project]]} {
   new_project -name Memory_stage_Structure -folder "D:/CAD/cad_lib/ps/Memory_stage_Structure"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Memory_stage_Structure"
}
...
catch {source "D:/CAD/cad_lib/ps/Memory_stage_Structure/hds/add_files.tcl"}
