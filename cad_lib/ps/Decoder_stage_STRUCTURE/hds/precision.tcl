...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/Decoder_stage_STRUCTURE/Decoder_stage_STRUCTURE.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Decoder_stage_STRUCTURE"
}
...
catch {source "D:/CAD/cad_lib/ps/Decoder_stage_STRUCTURE/hds/add_files.tcl"}
