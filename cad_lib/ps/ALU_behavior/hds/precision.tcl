...
if {[string length [info commands new_project]]} {
   open_project "D:/CAD/cad_lib/ps/ALU_behavior/ALU_behavior.psp"
   new_impl
} else {
   set_working_dir "D:/CAD/cad_lib/ps/ALU_behavior"
}
...
catch {source "D:/CAD/cad_lib/ps/ALU_behavior/hds/add_files.tcl"}
