...
if {[string length [info commands new_project]]} {
   new_project -name Reg_tracker -folder "D:/CAD/cad_lib/ps/Reg_tracker"
} else {
   set_working_dir "D:/CAD/cad_lib/ps/Reg_tracker"
}
...
catch {source "D:/CAD/cad_lib/ps/Reg_tracker/hds/add_files.tcl"}
