...
if {[string length [info commands new_project]]} {
   new_project -name Execute_stage -folder "G:/CAD/cad_lib/ps/Execute_stage"
} else {
   set_working_dir "G:/CAD/cad_lib/ps/Execute_stage"
}
...
catch {source "G:/CAD/cad_lib/ps/Execute_stage/hds/add_files.tcl"}
